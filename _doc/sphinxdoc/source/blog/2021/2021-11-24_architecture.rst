...
.. blogpost::
    :title: Architecture, Gilles Dupré
    :keywords: Gilles Dupré
    :date: 2021-11-24
    :categories: architecture

    Je n'imaginais que faire la liste des constructions de mon
    père, `Gilles Dupré <http://www.xavierdupre.fr/blog/2018-04-27_nojs.html>`_
    soit aussi fastidieuse. Les adresses des constructions sont
