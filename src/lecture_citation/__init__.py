...
<opml version="1.0">
    ...
    <body>
        <outline text="lecture_citation"
            title="lecture_citation"
            type="rss"
            xmlUrl="http://www.xavierdupre.fr/app/lecture_citation/helpsphinx/_downloads/rss.xml"
            htmlUrl="http://www.xavierdupre.fr/app/lecture_citation/helpsphinx/blog/main_0000.html" />
    </body>
</opml>
"""
